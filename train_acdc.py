"""
train_acdc.py — Train UNetResNet34 on ACDC with 2-channel input
================================================================
Channel 1: MRI image
Channel 2: Cardiac segmentation mask (LV/RV/Myo)

This is a separate training script from train.py.
Your original train.py and landmark_dataset.py are NOT modified.

Usage:
    python train_acdc.py
    python train_acdc.py --p2-checkpoint checkpoints/some_run/best_p2.pth
"""
...
def train(p2_checkpoint=None):
    ...
    print(f"In channels: {IN_CHANNELS} (MRI + seg mask)")
