...
def train_one_epoch(model, loader, optimizer, criterion, device, scaler=None, lm1_weight=1.5):
    """
...
def main():
    ...
    parser.add_argument("--lm1-weight", type=float, default=1.5,
                        help="Heatmap target multiplier for LM1 (channel 0). LM2 is always 1.0.")
